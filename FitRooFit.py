...
Ef = rt.RooRealVar("Ef","Ef",0.5,3.)

Ea = rt.RooArgList(E)
Eap = rt.RooArgSet(E)

ff = rt.TFile("Output_500.root","READONLY")
...
ffp = rt.TFile("Poissonizado_500.root","READONLY")
h_totalL = ffp.Get('total_Gaussrebin')
h_testnnL = ffp.Get('bb2nu_Gaussrebin')
tree = ffp.Get('t')


data = rt.RooDataSet("RealData","RealData",tree,Eap)
#ffp.Close()
...
h_testnn = rt.RooDataHist("h_total","h_total Gauss",Ea,h_testnnL)

pdf_Co   = rt.RooHistPdf("pdf_Co","pdf_Co Gauss",Eap,h_Co)
pdf_K    = rt.RooHistPdf("pdf_K","pdf_K Gauss",Eap,h_K)
pdf_Tl   = rt.RooHistPdf("pdf_Tl","pdf_Tl Gauss",Eap,h_Tl)
pdf_Bi   = rt.RooHistPdf("pdf_Bi","pdf_Bi Gauss",Eap,h_Bi)
pdf_bb2n = rt.RooHistPdf("pdf_bb2nu","pdf_bb2n Gauss",Eap,h_bb2n)


n_Co   = rt.RooRealVar("n_Co","n_Co",50000,0,1000000)
n_K    = rt.RooRealVar("n_K","n_K",50000,0,1000000)
n_Tl   = rt.RooRealVar("n_Tl","n_Tl",50000,0,1000000)
n_Bi   = rt.RooRealVar("n_Bi","n_Bi",50000,0,1000000)
n_bb2n = rt.RooRealVar("n_bb2nu","n_bb2ny",100000,0,1000000)
